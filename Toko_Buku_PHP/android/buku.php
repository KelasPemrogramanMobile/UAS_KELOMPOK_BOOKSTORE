<?php 	
	...
	$result = mysql_query("SELECT * FROM bukutbl inner join kategoritbl on bukutbl.kode_kategori = kategoritbl.kode_kategori where kategoritbl.id='$_GET[KatPos]' ORDER BY bukutbl.id desc LIMIT 0,50") or die(mysql_error());
